            ...
            else
            {
                ...
                switch (GetSpecialType(ID))
                {
                    ...
                    case SpecialType.T15_AdaGrappleGun:
                        ...
                        break;
                    case SpecialType.T06_MulitTriggerZone:
                        r += "0x" + Lang.GetAttributeText(aLang.SpecialType06_MulitTriggerZone);
                        break;
                ...
                else if (GetRefInteractionType(ID) == RefInteractionType.TakeIdFromESL)
                {
                    r += " - Take Id from ESL: 0x" + ReturnRefInteractionIndex(ID).ToString("X2");
                }
